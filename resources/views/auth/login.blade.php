        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                @if (Route::has('password.request'))
                    <a class="text-sm text-stone-500 hover:text-stone-800 transition"
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white text-stone-500">Or continue with</span>
                </div>
            </div>

            <a href="{{ route("google.login") }}"
                class="w-full rounded-xl border border-stone-300 px-4 py-3 text-sm font-medium text-stone-700 transition hover:bg-stone-50 flex items-center justify-center gap-2">
            ...
            <div class="text-center mt-4">
                <p class="text-sm text-stone-600">
                    ...
                    <a class="text-stone-800 hover:text-stone-600 transition font-medium"
                        href="{{ route('register') }}">
                        Register
                    </a>
                </p>
