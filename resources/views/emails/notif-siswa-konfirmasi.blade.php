...
<head>
    ...
    <title>Notifikasi Sesi Belajar Selesai</title>
    <style>
        body {
            margin: 0;
            padding: 0;
    ...
    <div class="email-wrapper">
        <div class="email-content">
            <div class="email-header">
                <h1>Sesi Belajar Selesai</h1>
                <p>Notifikasi sesi belajar Anda telah selesai</p>
            </div>
            <div class="email-body">
                <p>Halo{{ $order->user->name }},</p>
                <p>Sesi belajar Anda bersama <strong>{{ $order->guru->User->name }}</strong> telah
                    <strong>selesai</strong>. Terima kasih telah menggunakan layanan kami. Kami berharap sesi ini
                    bermanfaat untuk pembelajaran Anda.</p>
                <span class="badge">✓ Status: Sesi Selesai</span>
                <div class="details">
